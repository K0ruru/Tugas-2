let index = 0;
let selectedTimeFrame = "todayViews";
...
function renderMostViewedBooks() {
	...
	sortSlidesByViews(selectedTimeFrame);
	...
	for (let rank = 0; rank < 5; rank++) {
		...
		bookLink.href = slide.link;
		bookLink.classList.add("most__viewed__ranks");
		...
		mostViewedBook.appendChild(bookLink);
